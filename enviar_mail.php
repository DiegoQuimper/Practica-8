...
//comenzamos recogiendo los datos function recogeDato($campo){
...
//una vez recogidos, los validamos (campos obligatorios, etc...) if($email1==''){
...
//si encontramos un error, mostramos un mensaje
...
//comprobamos que el contenido de la pregunta no esté vacío
...
//comprobamos si ha habido algún error echo "<p>&nbsp;</p>\n";
...
//si todo es correcto, enviamos el correo
...
"Pregunta: ".$consulta; mail($para, $asunto, $mensaje);
